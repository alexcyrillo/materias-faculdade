/*
Escreva uma função que dada uma matriz de adjacências MA, o número de vértices de  G ,  n , imprima o seu respectivo grafo transposto  GT , representado por uma lista de adjacências (LA).
*/
#include <iostream>
#include <vector>
using namespace std;
