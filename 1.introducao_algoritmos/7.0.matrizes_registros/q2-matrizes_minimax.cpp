...
int main()
{
    int matriz[10][10], lMaior = 0, cMaior = 0, cMenor = 0;
    for(int l = 0; l < 10; l++)
    {
        for(int c = 0; c < 10; c++)
        {
    ...
    for(int l = 0; l < 10; l++)
    {
        for(int c = 0; c < 10; c++)
        {
            if(matriz[l][c] > matriz[lMaior][cMaior])
            {
                lMaior = l;
                cMaior = c;
            }
    ...
    for(int c = 0; c < 10; c++)
    {
        if(matriz[lMaior][c] < matriz[lMaior][cMenor])
            cMenor = c;
    }
    cout << matriz[lMaior][cMenor] << endl << lMaior << ' ' << cMenor;
    return 0;
}