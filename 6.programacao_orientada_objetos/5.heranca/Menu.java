...
public class Menu {
    ...
    private void simularInvestimentoPoupanca() {
        ...
        Aplicacao ap = new Poupanca(selic,tr,lerValorInicial());
    ...
    private void simularInvestimentoCdb() {
        ...
        Aplicacao ap = new Cdb(cdi,lerValorInicial());
    ...
    private void simularInvestimentoAcao() {
        ...
        Aplicacao ap = new Acao(precoInicial,precoFinal,lerValorInicial());
